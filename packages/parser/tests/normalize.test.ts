...
import { countWords, normalizeScriptText } from "../src/index.js";
...
describe("normalizeScriptText", () => {
  ...
  it("preserves case and punctuation", () => {
    expect(normalizeScriptText("MIRA: “Not again.”")).toBe("MIRA: “Not again.”");
  });
});

describe("countWords", () => {
  it("counts Unicode words and contractions", () => {
    expect(countWords("Mira can't forget काठमाडौं.")).toBe(4);
  });
});
