...
export interface AudienceFact {
  ...
  readonly confidence: "explicit" | "strong_inference" | "weak_inference";
...
export interface AudienceAssumption {
  ...
  readonly status: "active" | "confirmed" | "refuted" | "expired";
}
...
export function createEmptyAudienceState(runId: RunId): AudienceState {
  return {
    runId,
    ...
    assumptions: [],
    questions: [],
    compactNarrativeState: "No narrative information has been revealed yet.",
    revision: 0,
